...
class Container_8026385230 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\Presentation\Home\HomePresenter' => [2 => ['application.1']],
	...
	public function createServiceApplication__1(): App\Presentation\Home\HomePresenter
	{
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_8026385230 $container,
			) {
			}
